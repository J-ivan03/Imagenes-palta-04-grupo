...
-   **Revisión y Exportación**
    ...
    Después de realizar el etiquetado, el trabajo puede ser revisado por otros miembros del equipo (si se está trabajando en grupo). Los datos anotados pueden luego ser exportados en varios formatos, como JSON o CSV, para ser utilizados en el entrenamiento de modelos de Machine Learning. \# MATERIALES Y METODOS
...
-   **Etiquetado** Primero Seleccione la etiqueta para comenzar a dibujar alrededor de las imágenes haciendo puntos. ![](images/III.jpeg)

-   **El etiquetado se revisa y ajusta según sea necesario**

![](images/IV.jpeg) \## RESULTADOS
